        ...
        return (
            <>
                            ...
                            <div className="row" id={productId}>                           
                             <div className='col-lg-6 itemDino' style={{textAlign:"left",paddingLeft:"6%",fontFamily:'Comic Sans MS', fontSize:"18px"}}>
            ...
            <img src={imageName1} id="dinoImg" width="410px" alt={productName}/></div>
                               <div style={{textAlign:"left",paddingLeft:"4%",fontFamily:'Comic Sans MS',fontSize:"18px"}}><b>Description: </b>{description}</div>
