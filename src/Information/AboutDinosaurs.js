...
return(
    <div className="container" style={{margin:"110px 0px 0px 63px"}}>
      ...
      <CardActionArea>
      <Typography gutterBottom variant="h2" component="div" style={{fontFamily:"cursive", background:"black",color:"white",marginBottom:"0",paddingBottom:"25px",marginTop:"25px"}}>
          What are dinosaurs?
          </Typography>
          <div style={{color:"white"}}>--------------------------------------------------------------------------------------------------------------------------------------------------------</div>
        <CardMedia
        ...
        <CardContent className="col-lg-9" style={{margin:"auto",backgroundColor:"white"}} >
          {/* <Typography gutterBottom variant="h2" component="div" style={{color:"black", fontFamily:"cursive"}}>
          What are dinosaurs?
          </Typography><br/><br/> */}
          <Typography variant="body1" style={{textAlign:"left",fontFamily:"cursive",fontSize:"20px"}} color="text.secondary">
       ...
       <Typography variant="body1" style={{textAlign:"left",fontFamily:"cursive",fontSize:"20px"}} color="text.secondary">
       Some other non-dinosaur reptiles are also archosaurs, including pterosaurs (the now-extinct flying reptiles) and modern crocodiles and their ancestors.
</Typography><br/>          <Typography variant="body1" style={{textAlign:"left",fontFamily:"cursive",fontSize:"20px"}} color="text.secondary">
These and many other types of ancient reptiles are often wrongly called dinosaurs.
    ...
    Main characteristics dinosaurs share:
      ...
      <Typography style={{fontFamily:"cursive",fontSize:"16px"}}>By Sam Rae and Lisa Hendry
</Typography>
        </CardContent>
      </CardActionArea>
    </Card>
